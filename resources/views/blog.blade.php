      ...
      <div class="flex h-16 items-center justify-between">
          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3" x-data="{ profileOpen: false }">
              ...
              <div 
                ...
                style="display: none;"> <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Your profile</a>
        ...
        <div class="-mr-2 flex md:hidden">
          <button @click="mobileMenuOpen = !mobileMenuOpen" type="button" class="relative inline-flex items-center justify-center rounded-md bg-gray-800 p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
            ...
            <svg x-show="mobileMenuOpen" class="hidden size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" :class="{'block': mobileMenuOpen, 'hidden': !mobileMenuOpen}">
